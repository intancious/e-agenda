        ...
        <div class="card-body" id="form-data">
            <form action="#" id="form" class="form-horizontal">
                ...
                <div class="modal-footer">
                    <a class="btn btn-success shadow-sm" href="javascript:void(0)" onclick="edit_verif(<?= $agenda->id_agenda ?>)" tabindex="20">Verifikasi</a>
                    <a href="<?= base_url("superadmin/beranda"); ?>" class="btn btn-secondary" tabindex="21">Kembali</a>
                </div>
            </form>
        </div>
