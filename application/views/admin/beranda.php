...
<script type="text/javascript">
    ...
    let docuemtnready = function() {
        ...
        $.ajax({
            url: "<?= base_url("admin/beranda/getDataAgenda") ?>",
            dataType: "JSON",
            data: temporarydata,
            method: "POST",
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="row">
                        <div class="col-md-6">
                            <h6 class="m-0 font-weight-bold text-primary">` + get_date(v.tanggal, 'indonesia_with_dayFull') + `</h6>
                ...
                <a href="<?= base_url("admin/beranda/detail/"); ?>` + v.id_agenda + `" class="btn btn-light btn-sm" style="border-radius: 0;">Lihat Detail</a>
            </div>
        </div>`)
                    })
                } else {
